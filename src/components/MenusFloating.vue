...
const usedAudio: Ref<string> = ref(
  "https://dashboard.qinvi.my.id/storage/Frank%20Sinatra%20-%20L.O.V.E.mp3"
);
  ...
  >
    ...
    >
      <img
        ...
        class="pb-2"
      />
      <p class="caption-1 text-brown-10">Mempelai</p>
    </button>
    <button
      class="flex flex-col items-center px-1"
    ...
    >
      <img
        ...
        class="pb-2"
      />
      <p class="caption-1 text-brown-10">Acara</p>
    </button>
    <button
      class="flex flex-col items-center px-1"
    ...
    >
      <img
        ...
        class="pb-2"
      />
      <p class="caption-1 text-brown-10">Gallery</p>
    </button>
    <button
      class="flex flex-col items-center px-1"
      @click="
